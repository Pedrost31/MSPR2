...
exports.updateGoalsController = exports.getGoalsController = void 0;
...
const getGoalsController = async (req, res, next) => {
    try {
        ...
        (0, response_utils_1.sendSuccess)(res, goals);
    }
    catch (err) {
        next(err);
    }
...
const updateGoalsController = async (req, res, next) => {
    try {
        const goals = await goalService.updateGoals(req.user.userId, req.body);
        (0, response_utils_1.sendSuccess)(res, goals, 200, 'Objectifs mis à jour');
    }
    catch (err) {
        next(err);
    }
};
exports.updateGoalsController = updateGoalsController;
